# M2 runtime evidence — attempt 10
...
- Second failures: **0/2**
- Taper / candidate selection / learning / adversarial: **pass / pass / pass / fail**
- Deterministic prose errors: **18**
- Automated runtime thresholds: **FAIL**

| Scenario | Expected target action | Result | Target ? count | Suspicious attempts |
|---|---|---:|---:|---:|
| adversarial-data-not-instructions | answer | fail | 0 | 2 |
| candidate-selection-targeted-repair | repair | pass | 0 | 0 |
| false-positive-41-code-point-boundary | answer | pass | 0 | 2 |
| false-positive-embedded-marker | answer | pass | 0 | 0 |
| false-positive-fenced-code | answer | fail | 1 | 0 |
