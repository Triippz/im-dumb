# M2 runtime evidence — attempt 5

Fresh single-trial filesystem-harness captures. Raw responses were not edited. Attempts 1–4 are retained because behavior failures led to prompt changes; this is not rerolling an unchanged build.
